...
![Entity From Metadata Grid](/assets/img/2019-11-12-entityformmetadata-grid.jpg)
...
![Entity From Metadata Attribute Type](/assets/img/2019-11-12-attribute-type.jpg)

Then scroll to Control Style section. In the Control Style field select Render Lookup as Dropdown.

![Entity From Metadata Control Style](/assets/img/2019-11-12-control-style.jpg)
...
![Fetchxml Code](/assets/img/2019-11-12-fetchxmlcode.jpg)
...
![Custom Javascript](/assets/img/2019-11-12-custom-javascript.jpg)
