...
![AI Model](/assets/img/2019-07-23-ai-model.jpg)
...
![Trigger Step](/assets/img/2019-07-23-flow-trigger-step.jpg)

Then I will initialize two variables: Tag (text) and Score (Float). We will use them to contain our results.

![Init Variables](/assets/img/2019-07-23-init-variable.jpg)
...
![Predict Step](/assets/img/2019-07-23-predict-step.jpg)
...
![Parse JSON](/assets/img/2019-07-23-parse-json.jpg)
...
![Set Variables](/assets/img/2019-07-23-set-variables.jpg)
...
![Response](/assets/img/2019-07-23-response.jpg)
