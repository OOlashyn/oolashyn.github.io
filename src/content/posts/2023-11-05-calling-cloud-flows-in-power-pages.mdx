...
![Cloud flow trigger with inputs](/assets/img/2023-11-05-cloud-trigger-param.jpg)
...
![Add note step](/assets/img/2023-11-05-add-note.jpg)

Now when the note is created let's retrieve it back from the system.

![Get note step](/assets/img/2023-11-05-get-note.jpg)
...
![Return to Power Pages step](/assets/img/2023-11-05-return-to-power-pages.jpg)

Now our flow looks like this.

![Full cloud flow](/assets/img/2023-11-05-full-flow.jpg)
...
![Add cloud flow in Power Pages studio](/assets/img/2023-11-05-add-cloud-flow-in-studio.jpg)
...
<Video mp4="2023-11-05-cloud-flow-demo.mp4" />
