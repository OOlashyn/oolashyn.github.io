...
![Azure Workload](/assets/img/2019-08-15-azure-workload.jpg)
...
![Create Project](/assets/img/2019-08-15-create-new-project.jpg)
...
![Site URL](/assets/img/2019-08-15-site-url.jpg)
...
![Flow Template](/assets/img/2019-08-15-flow-template.jpg)
...
![Flow Variable](/assets/img/2019-08-15-flow-variable.jpg)
...
![Http Request](/assets/img/2019-08-15-http-request.jpg)
...
![PowerApps view](/assets/img/2019-08-15-powerapps-view.jpg)
...
![PowerApp OnStart](/assets/img/2019-08-15-powerapps-onstart.jpg)

Next on OnVisible event on each screen add a command to set gblScreen variable to the current screen.

![PowerApp OnVisible](/assets/img/2019-08-15-powerapps-onvisible.jpg)

Then we need to set an event on OnSelect event of the Awesome and Fantastic buttons.

![PowerApp OnSelect](/assets/img/2019-08-15-powerapps-onselect.jpg)
...
![PowerApp Events](/assets/img/2019-08-15-powerapps-sendevents.jpg)

**Events in App Insights**

![App Insights Overview](/assets/img/2019-08-15-app-insight-overview.jpg)

**Event Details**

![App Insights Event Details](/assets/img/2019-08-15-app-insight-event-details.jpg)
