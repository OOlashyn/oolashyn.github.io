...
![Create Model Driven App](/assets/img/2021-05-26-create-model-driven-app.jpg)

2) open a solution with an app, hit 3 dots and on the Edit option click on the arrow and select **"Edit in preview"**

![Edit Model Driven App](/assets/img/2021-05-26-edit-model-driven-app.jpg)
...
![New Editor](/assets/img/2021-05-26-new-editor.jpg)
...
![New Page dialog](/assets/img/2021-05-26-create-page-dialog.jpg)
...
![Configure forms](/assets/img/2021-05-26-page-edit-form.jpg)

* and you can configure available views

![Configure views](/assets/img/2021-05-26-page-edit-view.jpg)

For the dashboard page - you can edit the dashboard (which will open it in a separate window) or remove it.

![Edit dashboard](/assets/img/2021-05-26-page-dashboard-edit.jpg)
...
![Move subarea](/assets/img/2021-05-26-navigation-move.jpg)
...
![Data panel](/assets/img/2021-05-26-data.jpg)
