...
<strong>UPDATE</strong> There is a better way - there is a newer article covering this topic (published Oct 2024). Visit it using the <a href="https://www.dancingwithcrm.com/lookup-filtering-in-2024/">this article link</a>.
{% endcapture %}
